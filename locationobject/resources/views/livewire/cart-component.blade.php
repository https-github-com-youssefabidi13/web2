...
{{--                                    <th scope="col">Quantity</th>--}}
                        ...
                        <div class="cart-action text-end">
                            ...
                            <a aria-label="Add To Cart" class="btn  mr-10 mb-sm-15" href="#" wire:click.prevent="store({{$item->id}},{{Auth::user()->id }})"><i class="fi-rs-shopping-bag mr-10"></i>Valider Shopping</a>
                        </div>
