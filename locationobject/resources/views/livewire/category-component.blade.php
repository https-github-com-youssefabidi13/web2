                                ...
                                <div class="col-lg-4 col-md-4 col-6 col-sm-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product.details',['slug'=>$annonce->product->slug])}}">
                                                    <img class="default-img" src="{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-1.jpg" alt="{{$annonce->product->title}}">
                                                    <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-2.jpg" alt="{{$annonce->product->title}}">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <h2><a href="product-details.html">{{$annonce->title}}</a></h2>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href="{{route('product.details',['slug'=>$annonce->product->slug])}}">
                                                    <img class="default-img" src="{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-1.jpg" alt="{{$annonce->product->title}}">
                                                    <img class="hover-img" src="{{asset('assets/imgs/shop/product-')}}{{$annonce->product->id}}-1.jpg" alt="{{$annonce->product->title}}">
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            {{-- <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$annonce->products_id}},'{{$annonce->product->title}}' , {{$annonce->regular_price}} )">
