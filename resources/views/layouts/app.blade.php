            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-4">
                    <div class="header-info header-info-right">
                        ...
                        @else
                            <ul>
                                <li><i class="fi-rs-key"></i><a href="{{route('login')}}">Log In </a> / <a href="{{route('register')}}">Sign
                                        Up</a></li>
                            </ul>
                        @endif
                    </div>
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ route('annonce.add') }}">Add Annonce</a></li>
                                <li><a href="{{ route('annonce.mesAnnonces') }}">Mes Annonces</a></li>
                                @auth
