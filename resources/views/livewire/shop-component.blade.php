...
{{--                                            <span class="old-price"></span>--}}
                                        ...
                                        <div class="product-action-1 show">
                                            ...
                                            @else
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="#" wire:click.prevent="addToWishlist({{$annonce->id}},'{{$annonce->title}}',{{$annonce->regular_price}})"><i class="fi-rs-heart"></i></a>
                                            @endif
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$annonce->id}},'{{$annonce->title}}',{{$annonce->regular_price}},'{{$annonce->from}}','{{$annonce->to}}')"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
